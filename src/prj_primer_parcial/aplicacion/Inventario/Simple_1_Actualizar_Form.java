...
public class Simple_1_Actualizar_Form extends javax.swing.JFrame {
    ...
    private final Simple_1_Form parent;
    private final String articulo;
    /**
     * Creates new form Simple_1_Actualizar_Form
     */
    public Simple_1_Actualizar_Form(Simple_1_Form parent, String articulo) {
        this.parent = parent;
        this.articulo = articulo;
        initComponents();
        jTextField2.setText(articulo);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try (Socket socket = new Socket("localhost", 12345);
            ...
            oos.writeObject(new Articulo(nuevoCodigo, nuevoNombre, nuevoPrecio));
            oos.flush();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Simple_1_Actualizar_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Simple_1_Actualizar_Form().setVisible(true);
            }
        });
    }
